...
const Navbar = () => {
  ...
  return (
    <nav className='fixed w-full z-50 bg-blue-900 py-4 px-8 shadow-lg'>
        <div className='contaiter mx-auto flex justify-between items-center'>
            <div>
                <a href="#" className='text-3xl font-bold text-white'>Portfolio</a>
            </div>
        ...
        {
            showMenu && (
                <div className='md:hidden mt-4 bg-blue-950 h-screen rounded-lg p-4 flex flex-col space-y-4 text-center justify-center'>
